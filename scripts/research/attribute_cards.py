...
{{
  ...
  "subtype": "REQUIRED. For irl_moment pick the CLOSEST: banter_roast (friends/chat trash-talk, roasts, verbal duels) | prank_public (pranks, stunts, public-space interactions) | freakout_overreaction (rage, screaming, big emotional overreaction) | performance_rap (singing/rapping/freestyle/dancing) | wholesome (genuinely sweet or supportive) | solo_monologue (one person delivering advice, a story, commentary, or an interview answer — no interaction) | irl_other. irl_other is a LAST RESORT: first test the clip against EACH specific subtype — most irl clips fit one, and irl_other on a clip that plainly fits a subtype is a WRONG answer. For non-irl categories: a 1-2 word snake_case sub-genre, or 'none'",
  "subtype_why": "3-8 words justifying the subtype choice (for irl_other: why every specific subtype was rejected)",
