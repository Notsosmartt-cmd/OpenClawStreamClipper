...
_LEVERS = {
    ...
    "cuts_per_30s_med": ("style_profiles effect density (zooms/cutaways) — NOT clip_cuts",
                         "VISUAL cut rate the video CARRIES (A2 audit 2026-07-15: gaming = source-native game cams, raw==rendered; reaction rendered > raw = our zoom/freeze/cutaway effects read as cuts). Not an editing-cut measure."),
