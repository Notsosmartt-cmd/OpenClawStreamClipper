...
Related: [[concepts/label-paths-and-store-2026-07]] (how labels are sourced + the durable store) · [[concepts/plan-adaptive-clip-count-2026-07]] (the fitted score also unlocks content-driven clip COUNT — `fit_ranker.py --count-gate` emits `count_threshold`, shipped 2026-07-08, gated behind ranking ENABLE) · [[concepts/plan-calibration-loop]] · [[concepts/plan-pipeline-upgrade-2026-07]] ·
