...
Related: [[concepts/label-paths-and-store-2026-07]] (how labels are sourced + the durable store) · [[concepts/plan-adaptive-clip-count-2026-07]] (the fitted score also unlocks content-driven clip COUNT via a count gate) · [[concepts/plan-calibration-loop]] · [[concepts/plan-pipeline-upgrade-2026-07]] ·
