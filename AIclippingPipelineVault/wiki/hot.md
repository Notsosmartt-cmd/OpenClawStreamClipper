...
- **SFX/cold-open/flash VALIDATED on a real VOD (2026-07-03)** via the phase_runner harness (rakai, 10 clips): all stages rendered, no fatal, **integrated loudness −20.73 LUFS = SFX don't drown speech**. Perceptual seam-aesthetics spot-check still worth a human glance. New SFX kinds beyond boom still need CC0 assets — [[concepts/sfx-cue-taxonomy-2026-06]] · [[concepts/plan-pipeline-upgrade-2026-07]]
