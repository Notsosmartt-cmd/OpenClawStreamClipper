...
- [[entities/finals-clipper]] — THE FINALS game-specific app (:5200): OCR-detects revive banners + end-of-match screens, cuts buffered montage clips (no LLM)
- [[concepts/pipeline-checkpoints-2026-07]] — per-VOD save-state: crash mid-VOD resumes at the last completed stage; force = from 0
...
- [[concepts/handoff-2026-07-12]] — **HANDOFF (latest)**: captions/A/B shipped+promoted, reference loop closed (6× SFX measured), news mode + Reference Lab tab, kokoro voice, abandoned-routes table, open gates — start here
- [[concepts/handoff-2026-07-09]] — HANDOFF: speed campaign close-out + final scorecard, BUG 67 incident, moment-parallel, thinking control, companion shorts, doctrine
...
- [[concepts/plan-adaptive-clip-count-2026-07]] — Replace the 3/hour clip quota: Plan A bounds+tail floor + Plan B calibrated count gate (**both machinery shipped 2026-07-08**, default-off, neither enabled — needs labels)
...
- [[concepts/plan-pipeline-speed-2026-07]] — Speed plan FINAL: GREEN #1 cache/#2 threaded scan/#7 metrics (live every run); RED #3/#5/#6 (not integrated, archived) (**shipped 2026-07-09**)
...
- [[concepts/plan-serving-stack-2026-07]] — **Speed Wave 2 UNIFIED plan**: S1 spec decode + P prefill + C1 batch prefetch + C2 prefix-cache + C3 reload hygiene + C4 segment cache, execution-grade w/ file:line anchors + gates (**planned 2026-07-09**); §11 = programmatic runtime switching + CUDA PoC (2026-07-14)
- [[concepts/single-card-cuda-lane-2026-07]] — **measured matrix + call-site map**: where a 9B on NVIDIA-only CUDA (or Vulkan) fits vs the dual-GPU 35B — 3.6× model / 1.8× runtime / 6.4× combined per Pass-B call; rollout ladder L0–L3 SHIPPED, §6 production results + the pool/phase-pin laws (**shipped 2026-07-15**)
- [[concepts/plan-speed-wave3-2026-07]] — **Wave 3: fresh 3h VOD 90→~40-45 min, same hardware** — WhisperX mandate + overlaps + 9B-CUDA lane + vision diet + D6 render-overlap; measured Raud 60m48s→48m14s (**shipped 2026-07-15**)
- [[concepts/plan-captions-and-ab-variants-2026-07]] — Caption-LANGUAGE overhaul (fidelity judge, AI-tell linter, voice bank v2) + A/B variant renders + `clips/post_kits/` platform kit (**shipped 2026-07-10; ALL default-on after owner 9/9-GOOD review; voice-bank curation pending**)
...
- [[concepts/reference-shape-guide-2026-07]] — DRAFT per-category/subtype shape profiles + candidate guidance lines for the Phase-2 markup (payoff placement, durations, hooks, solo_monologue promotion)
- [[concepts/plan-s45-text-judge-2026-07]] — S4 extraction/judgment split: 35B evidence-packet judge at the existing phase boundary; kills logged w/ rationales (**shipped 2026-07-16, default ON**)
