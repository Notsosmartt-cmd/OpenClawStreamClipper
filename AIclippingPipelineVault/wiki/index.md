...
- [[concepts/plan-reference-deconstruction-2026-07]] — Loop-B rebuild: reference clips → editorial attribute CARDS → contrastive DIFF vs our clips → curated apply + retrieval few-shot + **Reference Lab dashboard tab** (execute/view/approve); no training (**in-progress — R0 done 59/59, R1 gate cleared 2026-07-11, full card batch running**)
- [[concepts/plan-news-compilation-2026-07]] — "Streamer News Today" third output mode: multi-VOD → one list-arc compilation (grid intro, headline stories, on-punchline pacing); format spec measured from the StreamerUpdate cards (**planned 2026-07-11**)
