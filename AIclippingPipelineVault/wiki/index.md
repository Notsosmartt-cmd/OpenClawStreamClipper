...
- [[concepts/single-card-cuda-lane-2026-07]] — **measured matrix + call-site map**: where a 9B on NVIDIA-only CUDA (or Vulkan) fits vs the dual-GPU 35B — 3.6× model / 1.8× runtime / 6.4× combined per Pass-B call; rollout ladder L0–L4 (**planned 2026-07-14**)
- [[concepts/plan-speed-wave3-2026-07]] — **Wave 3 plan: fresh 3h VOD 90→30-45 min, same hardware** — waves 0 WhisperX mandate (interpreter pin + diarization default-on) / A overlaps / B 9B-lane / C vision diet / D polish; full scorecard + gates (**planned 2026-07-14**)
