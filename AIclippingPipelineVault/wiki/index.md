...
- [[concepts/plan-reference-deconstruction-2026-07]] — Loop-B rebuild: reference clips → editorial attribute CARDS → contrastive DIFF vs our clips → curated apply + retrieval few-shot + **Reference Lab dashboard tab** (execute/view/approve); no training (**planned 2026-07-10**)
